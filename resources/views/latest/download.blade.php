...
<body>
    <div class="container">
        ...
        <div class="data">
            ...
            <table>
                <tr><td>NIS</td><td>:</td> <td>{{ $telat->student->nis }}</td></tr>
                <tr><td>Nama</td><td>:</td> <td>{{ $telat->student->name }} </td></tr>
                <tr><td>Rombel</td><td>:</td> <td>{{ $telat->student->rombel->rombel }}</td> </tr>
                <tr><td>Rayon</td><td>:</td> <td>{{ $telat->student->rayon->rayon }}</td></tr>
            </table>
        </div>
