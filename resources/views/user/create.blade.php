...
<div class="p-4 sm:ml-64">
    <div class="p-4 border-2 border-gray-200 bg-slate-100   rounded-lg dark:border-gray-700 mt-14">
        <h1 class="text-xl">Tambah Data User</h1>
        <h3 class="text-sm">
            <span class="text-gray-500">Home / Data User / </span>Tambah Data User
        </h3>
                ...
                <form action="{{ route('user.store') }}" method="post">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-indigo-500 dark:focus:border-indigo-500" placeholder="Email" required="">
                        </div>
                        <div>
